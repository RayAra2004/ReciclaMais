...
ALTER TABLE MATERIAL_RECICLAVEL ADD CONSTRAINT FK_MATERIAL_RECICLAVEL_4
...
ALTER TABLE RECICLA ADD CONSTRAINT FK_RECICLA_3
    FOREIGN KEY (FK_PONTO_COLETA_ID)
    REFERENCES CADASTRO_PONTO_COLETA (ID)
    ON DELETE CASCADE;
...
ALTER TABLE VALIDA ADD CONSTRAINT FK_VALIDA_3
    FOREIGN KEY (FK_CADASTRO_PONTO_COLETA_ID)
    REFERENCES CADASTRO_PONTO_COLETA (ID)
    ON DELETE CASCADE;
...
ALTER TABLE PERTENCE ADD CONSTRAINT FK_PERTENCE_3
