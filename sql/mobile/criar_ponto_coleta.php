...
if(autenticar($db_con)) {
	...
	if (isset($_POST['nome']) && isset($_POST['nota']) && isset($_POST['telefone']) && isset($_POST['materiais']) 
        && isset($_POST['cep']) && isset($_POST['tp_logradouro']) && isset($_POST['logradouro']) && isset($_POST['numero']) 
        && isset($_POST['estado']) && isset($_POST['cidade']) && isset($_POST['bairro']) && isset($_POST['latitude']) 
        && isset($_POST['longitude']) && isset($_FILES['img'])) {
		
		// Aqui sao obtidos os parametros
		$nome = $_POST['nome'];
		$preco = $_POST['nota'];
		$descricao = $_POST['telefone'];
        $nome = $_POST['materiais'];

        $nome = $_POST['cep'];
        $nome = $_POST['tp_logradouro'];
        $nome = $_POST['logradouro'];
        $nome = $_POST['numero'];
        ...
        $nome = $_POST['longitude'];
        
        //TODO: criar conta no imgur 
